### nDisplay Config
[Video Tutorial for this Guide](https://lsu.box.com/s/mvpjcfrcxsr10koj6wyn9whitj9wwsnb)
...
It's useful to note that we have poistioned the pivot of the Wall Mesh exactly 12ft (365.76cm) out from the screen. This pivot represents the origin of our scene as well as our camera tracking.
...
| [previous](../1-Unreal5.4-Base-Setup/README.md)| [home](../README.md#user-content-gms2-background-tiles--sprites---table-of-contents) | [next](../3-Motive(CameraTracking)/README.md#user-content-live-link)|
|---|---|---|
